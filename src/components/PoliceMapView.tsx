...
export function PoliceMapView({markers,selected,onSelect,onTrailSelect,trail=[]}:{markers:PoliceGeoMarker[];selected?:string;onSelect:(id:string)=>void;onTrailSelect?:(id:string)=>void;trail?:PoliceGeoTrail[]}){
