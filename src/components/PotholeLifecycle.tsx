...
export function ObservationProgression({defect}:{defect:RoadDefect}){
 ...
 return <section className="lifecycle-chart" aria-labelledby="lifecycle-title">
  ...
  <EvidenceCredit src={selectedImage} note={`${selected.detail} Days, dates, severity and actions are demo history, not source capture metadata. Reference photos do not establish a same-site progression or verify work or completion at this site.`}/>
