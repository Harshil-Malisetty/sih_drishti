...
export const navigation={
 ...
 municipal:[{id:'overview',label:'Overview',icon:Activity},{id:'defects',label:'Defects',icon:Wrench},{id:'map',label:'Map',icon:Map},{id:'planning',label:'Planning',icon:Construction}],
